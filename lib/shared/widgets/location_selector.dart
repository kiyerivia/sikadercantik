...
class LocationSelector extends HookConsumerWidget {
  ...
  final Function(String? villageId, String? rwId, String? posyanduId)
  onSelected;
    ...
    return Column(
      ...
      children: [
        ...
        if (selectedVillage.value != null) ...[
          ref
              .watch(rwsProvider(selectedVillage.value!))
              .when(
                data: (rws) => DropdownButtonFormField<String>(
                  initialValue: selectedRW.value,
                  isExpanded: true,
                  decoration: const InputDecoration(
                    labelText: 'RW',
        ...
        if (selectedRW.value != null) ...[
          ref
              .watch(posyandusProvider(selectedRW.value!))
              .when(
                data: (posyandus) => DropdownButtonFormField<String>(
                  initialValue: selectedPosyandu.value,
                  isExpanded: true,
                  decoration: const InputDecoration(
                    labelText: 'Posyandu',
